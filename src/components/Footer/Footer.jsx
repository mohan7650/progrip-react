...
const FOOTER_COLUMN_HREFS = [
  ...
  ["/#why", "/blog", "/#order", "/#applications", "/#contact"],
];

const SOCIAL_LINKS = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61592498126725",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/progrip_screws/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/progrip-screws/posts",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
