...
const FOOTER_COLUMNS = [
  {
    title: "Products",
    links: ["Browse all", "Metal studs", "Drywall", "Heavy duty", "View all"],
  },
  {
    title: "Company",
    links: ["About us", "Resources", "For pros", "Contact us", "Careers"],
  },
];
    ...
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div className="footer-brand">
          <img src={logo} alt="Pro-Grip Screws" className="footer-logo" />
        ...
        <div className="footer-col">
          ...
          {SOCIAL_LINKS.map((social) => (
            <a href="#" className="social-link" key={social.name}>
