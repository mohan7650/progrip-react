...
console.assert(PRODUCTS.filter((p) => p.categoryId === 2).length === 12);
console.assert(PRODUCTS.filter((p) => p.categoryId === 3).length === 15);
console.assert(PRODUCTS.filter((p) => p.categoryId === 4).length === 10);
