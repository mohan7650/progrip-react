...
export const PRODUCT_DETAILS = {
  ...
  "1-4": {
    ...
    desc: "Bulk packaging for high-volume drywall installations. Pro-Grip coarse thread screws, pre-sorted and ready for continuous work.",
    specs: [
  ...
  "1-6": {
    badge: "Box · Drywall Screw",
    title: ["Fine Thread", "Drywall Screw Box"],
    desc: "High-count fine thread carton for large-scale steel framing builds. Every screw meets Pro-Grip hardness and geometry specs.",
    specs: [
      { label: "COUNT", value: "8,000 PCS" },
      { label: "THREAD", value: "FINE" },
      { label: "DRIVE", value: "PHILLIPS #2" },
